...
public final class ChordExtension {
  ...
  public static final ChordExtension DIM = create(true, true,
      Arrays.asList(ChromaticInterval.MINOR_THIRD, ChromaticInterval.DIMINISHED_FIFTH), "dim", "°", "0");
  ...
  public static final ChordExtension AUG = create(true, true,
      Arrays.asList(ChromaticInterval.MAJOR_THIRD, ChromaticInterval.MINOR_SIXT), "aug", "+");
  ...
  private ChordExtension(String name, boolean removeThird, boolean removeFifth, List<ChromaticInterval> intervals,
      ChordExtension reference) {
  ...
  /**
   * @return the compact reference form of this extension. Multiple extensions exists that are semantically equivalent
   *         but have different {@link #getName() names}. However, all these equivalent extensions will have the same
   *         reference.
   */
  ...
  private static ChordExtension create(boolean removeThird, boolean removeFifth, ChromaticInterval interval,
      String name, String... altNames) {

    return create(removeThird, removeFifth, Collections.singletonList(interval), name, altNames);
  }

  private static ChordExtension create(boolean removeThird, boolean removeFifth, List<ChromaticInterval> intervals,
      String name, String... altNames) {
