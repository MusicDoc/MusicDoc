...
/**
 * A {@link Parser} responsible only for a sub-object. It will only {@link #parse(String) parse} a part of the string to
 * parse until the object to parse is completed. A parent {@link Parser} may afterwards continue the parsing from where
 * the {@link SubParser} ended.
 *
