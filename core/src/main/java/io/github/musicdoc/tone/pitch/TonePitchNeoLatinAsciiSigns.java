...
public class TonePitchNeoLatinAsciiSigns extends TonePitch {
   ...
   */
  public static final ToneNameStyleNeoLatinAsciiSigns STYLE = new ToneNameStyleNeoLatinAsciiSigns();
  ...
  private static final Collection<TonePitchNeoLatinAsciiSigns> PITCHES = Collections
  ...
  private TonePitchNeoLatinAsciiSigns(String name, ChromaticStep step, EnharmonicType enharmonicType,
      TonePitchNeoLatinAsciiSigns otherCase) {
  ...
  @Override
  public ToneNameStyleNeoLatinAsciiSigns getNameStyle() {
  ...
  @Override
  public TonePitchNeoLatinAsciiSigns with(ToneNameCase newCase) {
  ...
  /**
   * {@link ToneNameStyle} for {@link TonePitchNeoLatinAsciiSigns}.
   */
  public static final class ToneNameStyleNeoLatinAsciiSigns extends ToneNameStyleEuropean<TonePitchNeoLatinAsciiSigns> {

    private ToneNameStyleNeoLatinAsciiSigns() {
