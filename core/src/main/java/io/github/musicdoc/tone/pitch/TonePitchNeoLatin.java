 ...
 * from Italy. This style is used in countries like Italy, France, Spain, Portugal, Romania, Israel, Turkey, Greece,
 * Bulgaria, Russia, and in Latin America. It uses the syllables {@link #DO}, {@link #RE}, {@link #MI}, {@link #FA},
 * {@link #SOL}, {@link #LA}, {@link #SI} for the letters {@link TonePitchEnglish#C}, {@link TonePitchEnglish#D},
 * {@link TonePitchEnglish#E}, {@link TonePitchEnglish#F}, {@link TonePitchEnglish#G}, {@link TonePitchEnglish#A},
 * {@link TonePitchEnglish#B}. Enharmonic signs are represented textually in Italian language (diesis for #, bemolle for
 * b, and doppio for double).
 */
public class TonePitchNeoLatin extends TonePitch {
  ...
  private static final Collection<TonePitchNeoLatin> PITCHES = Collections
  ...
  private TonePitchNeoLatin(String name, ChromaticStep step, EnharmonicType enharmonicType,
      TonePitchNeoLatin otherCase) {
  ...
  @Override
  public ToneNameStyleNeoLatin getNameStyle() {
  ...
  @Override
  public TonePitchNeoLatin with(ToneNameCase newCase) {
  ...
  /**
   * {@link ToneNameStyle} for {@link TonePitchNeoLatin}.
   */
