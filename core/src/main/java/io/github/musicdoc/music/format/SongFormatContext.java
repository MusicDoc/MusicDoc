...
public class SongFormatContext {
  ...
  /**
   * @return {@code true} to normalize {@link io.github.musicdoc.music.score.section.ScoreSection}s, {@code false}
   *         otherwise.
   */
  ...
  /**
   * @return {@code true} to normalize {@link io.github.musicdoc.music.harmony.key.MusicalKey}s, {@code false}
   *         otherwise.
   */
