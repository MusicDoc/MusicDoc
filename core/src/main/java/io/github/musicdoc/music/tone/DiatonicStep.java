...
public enum DiatonicStep implements Interval {
  ...
  /**
   * The first tone of the {@link io.github.musicdoc.music.harmony.MusicalKey#getDiatonicScale() diatonic scale}.
   *
   * @see io.github.musicdoc.music.harmony.DiatonicInterval#UNISON
   ...
   * tone higher than {@link #S0}.
   *
   * @see io.github.musicdoc.music.harmony.DiatonicInterval#SECOND
   ...
   * tones higher than {@link #S0}.
   *
   * @see io.github.musicdoc.music.harmony.DiatonicInterval#THIRD
   ...
   * three tones higher than {@link #S0}.
   *
   * @see io.github.musicdoc.music.harmony.DiatonicInterval#FOURTH
   ...
   * tones higher than {@link #S0}.
   *
   * @see io.github.musicdoc.music.harmony.DiatonicInterval#FIFTH
   ...
   * tones higher than {@link #S0}.
   *
   * @see io.github.musicdoc.music.harmony.DiatonicInterval#SIXTH
   ...
   * six tones higher than {@link #S0}.
   *
   * @see io.github.musicdoc.music.harmony.DiatonicInterval#SEVENTH
