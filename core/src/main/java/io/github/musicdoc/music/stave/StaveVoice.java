...
public class StaveVoice {
    ...
    public boolean equals(Object obj) {
        ...
        if (!ObjectHelper.equals(this.name, other.name) || !ObjectHelper.equals(this.abbreviation, other.abbreviation) || !ObjectHelper.equals(this.instrument, other.instrument)) {
            return false;
        }
        return true;
    }
