 ...
 * {@link io.github.musicdoc.music.stave.Stave}. It always has a {@link #getValue()
...
public abstract class ValuedItem<SELF extends ValuedItem<SELF>> extends AbstractTransposable<SELF> {
    ...
    public boolean equals(Object obj) {
        ...
        if (!ObjectHelper.equals(this.value, other.value) || !ObjectHelper.equals(getTone(), other.getTone()) || !ObjectHelper.equals(this.decorations, other.decorations)) {
            return false;
        }
        return true;
    }
