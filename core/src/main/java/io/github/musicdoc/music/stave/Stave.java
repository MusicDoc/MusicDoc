...
public final class Stave extends AbstractTransposable<Stave> {
     ...
     * In case one or more {@link io.github.musicdoc.music.partiture.voice.PartitureVoiceLine lines}
     * in a {@link io.github.musicdoc.music.partiture.PartitureRow row} start with
     ...
     * {@link io.github.musicdoc.music.partiture.voice.PartitureVoiceLine line}.
     * In case a {@link Stave} is not at the beginning of a {@link io.github.musicdoc.music.partiture.voice.PartitureVoiceLine line},
     ...
     * If this is the first {@link Stave} of a {@link io.github.musicdoc.music.partiture.Partiture}
