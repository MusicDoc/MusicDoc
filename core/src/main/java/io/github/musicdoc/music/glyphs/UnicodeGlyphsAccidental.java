...
/**
 * {@link SmuflGlyphs} for accidentals.
 */
public interface UnicodeGlyphsAccidental extends UnicodeGlyphs {

  /** The single flat symbol: {@value}. */
  String FLAT_1 = Character.toString(UnicodeGlyphsAccidental.FLAT_1_CHAR);
