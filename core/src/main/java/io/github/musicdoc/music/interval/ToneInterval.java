...
public interface ToneInterval {
   ...
   *         {@link io.github.musicdoc.music.tone.Tone}s in a {@link io.github.musicdoc.music.stave.Stave} by one
   *         octave, you write a small 8 below the {@link io.github.musicdoc.music.clef.Clef} symbol. Now to lower by
   ...
   *         {@link io.github.musicdoc.music.tone.Tone#transpose(ToneInterval, io.github.musicdoc.music.transpose.TransposeContext)
   *         transpose} a {@link io.github.musicdoc.music.tone.Tone} by adding a primum (Latin for {@code 1}.), you get
