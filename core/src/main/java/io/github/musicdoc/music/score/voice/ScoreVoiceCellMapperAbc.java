 ...
 */
public class ScoreVoiceCellMapperAbc extends ScoreVoiceCellMapper {

  /** The singleton instance. */
  public static final ScoreVoiceCellMapperAbc INSTANCE = new ScoreVoiceCellMapperAbc();

  /**
   * The constructor.
   */
  protected ScoreVoiceCellMapperAbc() {
