...
public class TonePitchEnglish extends TonePitch {
  ...
  private static final Collection<TonePitchEnglish> PITCHES = Collections
  ...
  @Override
  public TonePitchEnglish with(ToneNameCase newCase) {
  ...
  /**
   * {@link ToneNameStyle} for {@link TonePitchEnglish}.
   */
