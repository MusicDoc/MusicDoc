...
/**
 * {@link PartitureLine} for a single voice (inside the {@link io.github.musicdoc.music.stave.Stave},
...
public class PartitureVoiceLine extends PartitureLine<PartitureVoiceCell, PartitureVoiceLine> {
     ...
     * if this is the first line of a new {@link io.github.musicdoc.music.partiture.PartitureRow row}.
     */
