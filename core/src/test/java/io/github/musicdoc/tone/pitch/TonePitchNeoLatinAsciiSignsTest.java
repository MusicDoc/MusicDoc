...
public class TonePitchNeoLatinAsciiSignsTest extends AbstractTonePitchTest {
  ...
  public void testSingleSharpEnharmonicChanges() {
    ...
    verifyEnharmonicChange(TonePitchNeoLatinAsciiSigns.MI_SHARP, "Mi#", EnharmonicType.SINGLE_SHARP, TonePitchNeoLatinAsciiSigns.FA,
        TonePitchNeoLatinAsciiSigns.MI, TonePitchNeoLatinAsciiSigns.MI_DOUBLE_SHARP);
    // verifyEnharmonicChange(TonePitchNeoLatinAsciiSigns.LA_SHARP, "La#", EnharmonicType.SINGLE_SHARP,
    // TonePitchNeoLatinAsciiSigns.LA_SHARP, TonePitchNeoLatinAsciiSigns.A, TonePitchNeoLatinAsciiSigns.AISIS);
    verifyEnharmonicChange(TonePitchNeoLatinAsciiSigns.SI_SHARP, "Si#", EnharmonicType.SINGLE_SHARP, TonePitchNeoLatinAsciiSigns.DO,
        TonePitchNeoLatinAsciiSigns.SI, TonePitchNeoLatinAsciiSigns.SI_DOUBLE_SHARP);
  }

  @Test
  public void testSingleFlatEnharmonicChanges() {

    verifyEnharmonicChange(TonePitchNeoLatinAsciiSigns.DO_FLAT, "Dob", EnharmonicType.SINGLE_FLAT, TonePitchNeoLatinAsciiSigns.SI,
        TonePitchNeoLatinAsciiSigns.DO_DOUBLE_FLAT, TonePitchNeoLatinAsciiSigns.DO);
    verifyEnharmonicChange(TonePitchNeoLatinAsciiSigns.RE_FLAT, "Reb", EnharmonicType.SINGLE_FLAT, TonePitchNeoLatinAsciiSigns.DO_SHARP,
        TonePitchNeoLatinAsciiSigns.RE_DOUBLE_FLAT, TonePitchNeoLatinAsciiSigns.RE);
    verifyEnharmonicChange(TonePitchNeoLatinAsciiSigns.MI_FLAT, "Mib", EnharmonicType.SINGLE_FLAT, TonePitchNeoLatinAsciiSigns.RE_SHARP,
        TonePitchNeoLatinAsciiSigns.MI_DOUBLE_FLAT, TonePitchNeoLatinAsciiSigns.MI);
    verifyEnharmonicChange(TonePitchNeoLatinAsciiSigns.FA_FLAT, "Fab", EnharmonicType.SINGLE_FLAT, TonePitchNeoLatinAsciiSigns.MI,
        TonePitchNeoLatinAsciiSigns.FA_DOUBLE_FLAT, TonePitchNeoLatinAsciiSigns.FA);
    verifyEnharmonicChange(TonePitchNeoLatinAsciiSigns.SOL_FLAT, "Solb", EnharmonicType.SINGLE_FLAT, TonePitchNeoLatinAsciiSigns.FA_SHARP,
        TonePitchNeoLatinAsciiSigns.SOL_DOUBLE_FLAT, TonePitchNeoLatinAsciiSigns.SOL);
    verifyEnharmonicChange(TonePitchNeoLatinAsciiSigns.LA_FLAT, "Lab", EnharmonicType.SINGLE_FLAT, TonePitchNeoLatinAsciiSigns.SOL_SHARP,
        TonePitchNeoLatinAsciiSigns.LA_DOUBLE_FLAT, TonePitchNeoLatinAsciiSigns.LA);
  }

  @Test
  public void testDoubleSharpEnharmonicChanges() {

    verifyEnharmonicChange(TonePitchNeoLatinAsciiSigns.DO_DOUBLE_SHARP, "Do##", EnharmonicType.DOUBLE_SHARP, TonePitchNeoLatinAsciiSigns.RE,
