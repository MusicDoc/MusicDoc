...
public class SongFormatMusicDocTest extends SongFormatTest {
  ...
  public void testWriteLyricsWithChords() {
    ...
    line.addCell(new ScoreVoiceCell(ChordMapperMusicDoc.INSTANCE.read("Bm7"), "b "));
  ...
  public void testReadLyricsWithScore() {
    ...
    // when
    Score score = SongFormatMusicDoc.INSTANCE.getScoreMapper().read(lyrics);
    ...
    checkCell(voiceLine.getCell(cellIndex++), "b ", new Chord(TonePitchEnglish.B, TonalSystem.of("m"), ChordExtension._7),
        new Note(Tone.of(TonePitchEnglish.B, 4), MusicalValue._1_2));
    checkCell(voiceLine.getCell(cellIndex++), "c ", new Chord(TonePitchEnglish.C, TonalSystem.MAJOR_EMPTY, ChordExtension.ADD_9),
