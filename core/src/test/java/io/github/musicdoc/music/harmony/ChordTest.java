...
public class ChordTest extends AbstractTest {
  ...
  public void testParse() {
    ...
    checkEqualsAndHashCode(ChordMapper.INSTANCE.parse("C"), new Chord(TonePitchEnglish.C, TonalSystem.MAJOR_EMPTY),
        true);
  ...
  public void testTransposeChromatic() {
    ...
    assertThat(ChordMapper.INSTANCE.parse("E\u266Dmadd9/A").transposeChromatic(-1).getName())
        .isEqualTo("Dmadd9/G\u266F");
    assertThat(ChordMapper.INSTANCE.parse("Cis4add9no5/A").transposeChromatic(-1).toString())
  ...
  public void testTransposeInterval() {
    ...
    // chromatic
    assertThat(ChordMapper.INSTANCE.parse("C\u266F7/B\u266D").transpose(ChromaticInterval.PERFECT_FOURTH,
