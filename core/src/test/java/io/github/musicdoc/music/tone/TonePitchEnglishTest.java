...
public class TonePitchEnglishTest extends AbstractTonePitchTest {
  ...
  public void testSingleFlatEnharmonicChanges() {
    ...
    verifyEnharmonicChange(TonePitchEnglish.C_FLAT, "Cb", EnharmonicType.SINGLE_FLAT, TonePitchEnglish.B, TonePitchEnglish.C_DOUBLE_FLAT,
        TonePitchEnglish.C);
    verifyEnharmonicChange(TonePitchEnglish.D_FLAT, "Db", EnharmonicType.SINGLE_FLAT, TonePitchEnglish.C_SHARP, TonePitchEnglish.D_DOUBLE_FLAT,
        TonePitchEnglish.D);
    verifyEnharmonicChange(TonePitchEnglish.E_FLAT, "Eb", EnharmonicType.SINGLE_FLAT, TonePitchEnglish.D_SHARP, TonePitchEnglish.E_DOUBLE_FLAT,
        TonePitchEnglish.E);
    verifyEnharmonicChange(TonePitchEnglish.F_FLAT, "Fb", EnharmonicType.SINGLE_FLAT, TonePitchEnglish.E, TonePitchEnglish.F_DOUBLE_FLAT,
        TonePitchEnglish.F);
    verifyEnharmonicChange(TonePitchEnglish.G_FLAT, "Gb", EnharmonicType.SINGLE_FLAT, TonePitchEnglish.F_SHARP, TonePitchEnglish.G_DOUBLE_FLAT,
        TonePitchEnglish.G);
    verifyEnharmonicChange(TonePitchEnglish.A_FLAT, "Ab", EnharmonicType.SINGLE_FLAT, TonePitchEnglish.G_SHARP, TonePitchEnglish.A_DOUBLE_FLAT,
        TonePitchEnglish.A);
  }
  ...
  public void testDoubleSharpEnharmonicChanges() {
    ...
    verifyEnharmonicChange(TonePitchEnglish.E_DOUBLE_SHARP, "E##", EnharmonicType.DOUBLE_SHARP, TonePitchEnglish.F_SHARP, TonePitchEnglish.E_SHARP,
        null);
    ...
    verifyEnharmonicChange(TonePitchEnglish.B_DOUBLE_SHARP, "B##", EnharmonicType.DOUBLE_SHARP, TonePitchEnglish.C_SHARP, TonePitchEnglish.B_SHARP,
        null);
  }
