...
public abstract class AbstractTonePitchTest extends Assertions {
  ...
  protected void verify(TonePitch pitch, String name, ChromaticStep step, EnharmonicType type, boolean normal, TonePitch reference,
      TonePitch flattened, TonePitch sharpened, ToneNameStyle style, ToneNameCase nameCase) {
  ...
  protected void verify(TonePitch pitch, String name, ChromaticStep step, EnharmonicType type, boolean normal, TonePitch reference,
      TonePitch flattened, TonePitch sharpened, ToneNameStyle style) {
  ...
  protected void verifyEnharmonicChange(TonePitch pitch, String name, EnharmonicType type, TonePitch reference, TonePitch flattened,
      TonePitch sharpened) {
